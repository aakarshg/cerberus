...
def main(cfg):
    ...
    if os.path.isfile(cfg):
        ...
        while (int(iteration) < iterations):
            ...
            if (watch_nodes_status and watch_etcd_status and
                    watch_openshift_apiserver_status and
                    watch_kube_apiserver and
                    watch_monitoring_stack_status and watch_kube_controller):
